...
#
###############################################################################
class PlotGRB(object):
    """
    Class to plot GRB simulations result

    Could be a method of GRB - to be changed
    """

   ############################################################################
    @staticmethod
    def plot_stats_detection(grb, simulations, ax_excess=None, ax_relative=None, ax_bkg=None, ax_sigma=None, savefig=False, outdir='./out/'):
