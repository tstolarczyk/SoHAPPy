...
erec_min = {"FullArray"  :    {"20deg":  30*u.GeV -safe_margin,
            ...
            "4LSTs09MSTs":    {"20deg":  30*u.GeV -safe_margin,
             ...
             "14MSTs37SSTs" : {"20deg": 110*u.GeV -safe_margin,
                               "40deg": 110*u.GeV -safe_margin,
                               "60deg": 250*u.GeV -safe_margin
                              }
            }
...
erec_edges = { 
"FullArray":    np.asarray([30, 40, 56, 110., 200, 250, 316, 562,
                         1000, 1778, 3162, 5623, 10000, 15000])*u.GeV,
"4LSTs09MSTs":  np.asarray([30, 40, 56, 110., 200, 250, 316, 562,
                         1000, 1778, 3162, 5623, 10000, 15000])*u.GeV,
"LST":          np.asarray([30, 40, 56, 110., 200, 250, 316, 562,
                         1000, 1778, 3162, 5623, 10000, 15000])*u.GeV,
"MST":          np.asarray([30, 40, 56, 110., 200, 250, 316, 562,
                         1000, 1778, 3162, 5623, 10000, 15000])*u.GeV,
"14MSTs37SSTs": np.asarray([30, 40, 56, 110., 200, 250, 316, 562,
                          1000, 1778, 3162, 5623, 10000, 15000])*u.GeV
             }
...
class IRF():
    ...
    def from_observation(cls,
        ...
        erec_axis = MapAxis.from_edges(erec_edges[subarray].to("TeV").value,
                                       unit="TeV",
                                       name="energy",
                                       interp="log")
    ...
    ###------------------------------------------------------------------------
    def containment_plot(self,eunit="GeV",subarray=None,tag=None, ax=None):
        ...
        e_edges = np.append(np.array([0.01,0.02]), self.ereco.edges.value)
        e2plot = MapAxis.from_edges(e_edges,unit="TeV",
                                            name="energy",
                                            interp="log")
        radii = self.irf['psf'].containment_radius(energy=e2plot.edges,
                                                 theta = mcf.offset[subarray],
                                                 fraction=mcf.containment)[0]
...
if __name__ == "__main__":
    ...
    if "containment" in show:
        for loc in ["North","South"]:
            ...
            fig.suptitle(array[loc]+" "+loc,fontsize=18,y=0.98)
